  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        {/* Section Header */}
        <div className="approach-header mb-20 lg:mb-32 max-w-4xl">
             ...
             >
                ...
                <div className="relative z-10 space-y-8">
                   ...
                   <div className="space-y-4">
                      <h3 className="text-3xl lg:text-5xl font-black text-[#0F172A] uppercase tracking-tighter leading-[0.9] font-['Outfit',sans-serif]">
                         {item.title}
                      </h3>
                      <p className="text-lg lg:text-xl font-bold text-black/40 group-hover:text-black transition-colors duration-500 leading-tight tracking-tight">
                         {item.description}
                      </p>
                   </div>
