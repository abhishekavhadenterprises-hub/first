...
export function OurTeamSection() {
   ...
   return (
      <section
         ref={containerRef}
         className="relative py-24 lg:py-32 bg-[#FDFDFC]"
      >
            ...
            <div className="team-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
               {teamNodes.map((node, idx) => (
                  <motion.div
                     ...
                     className="team-capsule group relative aspect-[4/5] rounded-[3.5rem] overflow-hidden border border-black/5 shadow-[0_40px_100px_rgba(0,0,0,0.03)]"
                  >
                     {/* Visual Base */}
