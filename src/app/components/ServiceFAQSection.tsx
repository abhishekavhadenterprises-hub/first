        ...
        <div className="flex flex-col lg:flex-row gap-20 lg:gap-32">
          ...
          <div className="w-full lg:w-1/3">
             ...
             <div className="faq-header-item p-10 bg-white border border-black/[0.04] rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.05)]">
                ...
                <button className="w-full py-5 bg-[#0F172A] text-white rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] hover:bg-[#4EA62F] transition-all duration-500">
                   Contact Consultant
                </button>
             </div>
          </div>
