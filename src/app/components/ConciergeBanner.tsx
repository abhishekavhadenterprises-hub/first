...
export const ConciergeBanner = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex items-center justify-center bg-[#FDFDFC] overflow-hidden selection:bg-[#4EA62F] selection:text-white pt-40 pb-12 md:pt-48"
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-[40%] left-0 w-full overflow-hidden opacity-[0.04] select-none pointer-events-none">
          <div className="text-[25vw] font-[1000] tracking-tighter uppercase whitespace-nowrap animate-marquee">
            PREMIUM CONCIERGE • PREMIUM CONCIERGE • PREMIUM CONCIERGE
          </div>
        </div>
      </div>
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          >
            <div className="banner-node inline-flex items-center gap-4 px-6 py-2.5 bg-white shadow-[0_20px_50px_rgba(0,0,0,0.03)] border border-black/[0.04] rounded-full group cursor-default mx-auto lg:mx-0">
            ...
            <p ref={subheadlineRef} className="banner-subheadline max-w-xl mx-auto lg:mx-0 text-[18px] md:text-[24px] text-black/40 font-bold leading-[1.15] tracking-tight">
              Your dedicated partner for a seamless study abroad experience. From selection to arrival, we manage every detail.
            </p>

            <div className="banner-node flex flex-col md:flex-row items-center gap-8 justify-center lg:justify-start pt-6">
              <div
                ref={magneticBtnRef}
              ...
              >
                <button
                  ...
                  className="group relative h-24 w-full md:px-16 bg-white text-[#0F172A] rounded-full overflow-hidden shadow-[0_40px_80px_rgba(255,255,255,0.05)] flex items-center justify-center transition-transform active:scale-95 transform"
                >
                  <span className="relative z-20 font-black uppercase tracking-[0.5em] text-[12px] flex items-center gap-6 group-hover:text-white transition-colors duration-500">
              ...
              <button className="group relative flex items-center gap-6 py-4 px-6 rounded-full overflow-hidden transition-all duration-500 transform">
                <div className="relative z-20 flex items-center gap-6">
                  <div className="w-16 h-16 bg-white border border-black/[0.05] rounded-full flex items-center justify-center shadow-xl group-hover:bg-white group-hover:text-[#4EA62F] transition-all duration-700">
                    <Play size={18} fill="currentColor" />
                  </div>
                  <div className="flex flex-col text-left">
                    <span className="text-[9px] font-black uppercase tracking-[0.3em] text-[#4EA62F] group-hover:text-white transition-colors">Process Reel</span>
                    <span className="text-[12px] font-black uppercase tracking-[0.2em] text-black/30 group-hover:text-white transition-colors">Watch Introduction</span>
                  </div>
                </div>
                <div className="absolute inset-0 bg-[#4EA62F] scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-700 z-10" />
              </button>
            ...
            {/* Status Metrics */}
            <div className="banner-node flex flex-wrap justify-center lg:justify-start gap-10 lg:gap-14 pt-12 opacity-80">
              {[
          ...
          <div className="lg:col-span-5 relative group perspective-[2500px] hidden lg:block">
            <div
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1523050335392-495d4ed3679d?q=80&w=1080&auto=format&fit=crop"
                alt="Concierge Service"
                className="hero-parallax-img h-[125%] w-full object-cover transition-all duration-[2500ms] group-hover:scale-105 absolute top-[-10%]"
              />
